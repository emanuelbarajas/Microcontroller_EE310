...
# 53 "main.c" 2
# 1 "/Applications/microchip/xc8/v3.10/pic/include/c99/string.h" 1 3
# 25 "/Applications/microchip/xc8/v3.10/pic/include/c99/string.h" 3
# 1 "/Applications/microchip/xc8/v3.10/pic/include/c99/bits/alltypes.h" 1 3
# 421 "/Applications/microchip/xc8/v3.10/pic/include/c99/bits/alltypes.h" 3
typedef struct __locale_struct * locale_t;
# 26 "/Applications/microchip/xc8/v3.10/pic/include/c99/string.h" 2 3
...
unsigned char ready_for_step = 1;
...
unsigned int Step_Detection(unsigned int x_val,
                            unsigned int y_val);
...
void __attribute__((picinterrupt(("")))) ISR(void)
{
    if(PIR0bits.IOCIF)
    {
        if(IOCCFbits.IOCCF3)
        {
            ...
            {
                LATDbits.LATD2 = 1;
                _delay((unsigned long)((250)*(1000000UL/4000.0)));
...
void LCD_Init(void)
{
    ...
    LCD_Command(0x08);
    _delay((unsigned long)((5)*(1000000UL/4000.0)));
...
void LCD_Command(unsigned char cmd)
{
    ...
    _delay((unsigned long)((3)*(1000000UL/4000.0)));
}
...
void LCD_String_xy(unsigned char row,
                   unsigned char pos,
                   const char *msg)
{
